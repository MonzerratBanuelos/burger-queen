      ...
      {newProduct === null
        ...
        : <section className='form_products'>
          ...
          <form onSubmit={(e) => { setTheFunction(e) }}>
            ...
            <button className='btn_products' id='btn_delete_products' onClick={() => { setLoading(true); deleteProduct(currentProduct.id); setLoading(false); setAside(null) }} > Eliminar producto </button>
          </form>
        </section>
      }
    </>
